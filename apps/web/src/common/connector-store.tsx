...
export function ConnectorStore({ availableTypes }: { availableTypes: string[] }) {
          ...
          {results.map((entry) => {
            ...
            return (
              <div
                ...
                className="group flex flex-col items-center gap-3 rounded-xl border border-border bg-card p-5 text-center transition-colors hover:border-border/70 hover:bg-accent/5"
              >
                <div className="flex size-12 items-center justify-center transition-transform group-hover:scale-110">
                  <BrandIcon slug={entry.slug} size={40} />
                </div>
